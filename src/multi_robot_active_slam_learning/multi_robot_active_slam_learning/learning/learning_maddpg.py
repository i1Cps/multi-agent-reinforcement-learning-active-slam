...
class LearningMADDPG(Node):
    ...
    def start(self):
        ...
        filename = "./src/active_slam_learning/active_slam_learning/learning/maddpg/plots/maddpg.png"
        np.save("maddpg_score.npy", np.array(self.score_history))
        np.save("maddpg_steps.npy", np.array(x))
